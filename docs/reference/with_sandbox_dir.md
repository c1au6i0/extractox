...
are redirected to temporary directories. This function was implemented
...
#> /tmp/Rtmp8sSn5D/tmp-home1f2cb7e4bf57c
condathis::with_sandbox_dir(print(tools::R_user_dir("condathis")))
#> [1] "/tmp/Rtmp8sSn5D/tmp-data1f2cb237d2685/R/condathis"
```
