# extractox ![logo](reference/figures/extractox.png)
...
function allows to search for assay names that match a pattern you’re
interested in. Please note that searches are case sensitive and accept
regexp.
